...
import com.dheril.githubuser.ui.fragment.UserDetailFragmentDirections
...
class FollowListAdapter : ListAdapter<ItemsItem, FollowListAdapter.MyViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener { view ->
            val toUserDetailFragment = UserDetailFragmentDirections.actionUserDetailFragmentSelf()
